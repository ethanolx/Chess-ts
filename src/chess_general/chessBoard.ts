...
export class ChessBoard {
    ...
    castle(oldPos: [number, number], newPos: [number, number]): void {
        const TempRook = this.board[newPos[0]][newPos[1]].piece;
        TempRook.hasMoved = true;
        const TempKing = this.board[oldPos[0]][oldPos[1]].piece;
        ...
        if (newPos[1] > oldPos[1]) {
            this.board[oldPos[0]][oldPos[1] + 2].piece = TempKing;
            this.board[oldPos[0]][oldPos[1] + 1].piece = TempRook;
        }
        // castle left
        else {
            this.board[oldPos[0]][oldPos[1] - 2].piece = TempKing;
